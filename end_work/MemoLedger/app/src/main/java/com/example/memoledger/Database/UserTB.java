package com.example.memoledger.Database;
...
import com.example.memoledger.Database.NotepadDB.DatabaseHelper;
...
public class UserTB {
    ...
    public int updatePassword(String account, String newPassword) {
        ContentValues values = new ContentValues();
        values.put(USER_PWD, newPassword);
        return mWdb.update(USER_TABLE, values, USER_ACCOUNT + "=?", new String[]{account});
    }
